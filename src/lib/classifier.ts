...
export const RISK_RULES: readonly RiskRuleSet[] = [
  {
    ...
    terms: [
      ...
      { term: '전환가액 조정', weight: 5 },
      { term: '전환가액', weight: 3 },
      { term: '리픽싱', weight: 5 },
      { term: '신주 발행', weight: 4 },
      { term: '신주모집', weight: 3 },
      { term: '발행주식총수', weight: 3 },
      { term: '전환가능 주식수', weight: 4 },
      { term: '주식매수선택권', weight: 3 },
      { term: '상환전환우선주', weight: 4 },
      { term: '오버행', weight: 4 },
      { term: '희석', weight: 5 },
    ],
  },
  {
    ...
    terms: [
      ...
      { term: '차입금 상환', weight: 5 },
      { term: '만기 도래', weight: 4 },
      { term: '대환', weight: 4 },
      { term: '차환', weight: 5 },
      { term: '상환 재원', weight: 4 },
      { term: '원리금 상환', weight: 4 },
      { term: '조기상환청구권', weight: 5 },
      { term: '풋옵션', weight: 4 },
      { term: '만기 연장', weight: 4 },
      { term: '브릿지론', weight: 3 },
    ],
  },
  {
    ...
    terms: [
      ...
      { term: '현금성자산', weight: 3 },
      { term: '현금 소진', weight: 5 },
      { term: '운전자금 부족', weight: 5 },
      { term: '운전자금', weight: 3 },
      { term: '유동성', weight: 5 },
      { term: '계속기업', weight: 6 },
      { term: '영업현금흐름 적자', weight: 5 },
      { term: '최소 매출액 약정', weight: 4 },
      { term: '현금 회수기간', weight: 4 },
    ],
  },
  {
    ...
    terms: [
      ...
      { term: '관계사', weight: 3 },
      { term: '내부통제', weight: 5 },
      { term: '이사회 독립성', weight: 4 },
      { term: '공정성 의견', weight: 4 },
      { term: '콜옵션', weight: 4 },
      { term: '의결권', weight: 3 },
    ],
  },
  {
    ...
    terms: [
      ...
      { term: '인허가', weight: 4 },
      { term: '고객사 승인', weight: 5 },
      { term: '양산', weight: 4 },
      { term: '상업 생산', weight: 4 },
      { term: '생산설비 증설', weight: 4 },
      { term: '임상시험', weight: 4 },
      { term: '품목허가', weight: 5 },
      { term: '환경 인허가', weight: 5 },
      { term: '시험가동', weight: 4 },
      { term: '수율', weight: 4 },
      { term: '발사 일정', weight: 5 },
      { term: '시스템 통합', weight: 4 },
    ],
  },
  {
    label: 'Market Risk',
    terms: [
      ...
      { term: '수요 둔화', weight: 5 },
      { term: '고객 수요', weight: 4 },
      { term: '원재료 가격', weight: 4 },
      { term: '전력요금', weight: 3 },
      { term: '환율', weight: 3 },
      { term: '금리 상승', weight: 4 },
      { term: '주가 변동성', weight: 4 },
      { term: '시장 변동성', weight: 4 },
      { term: '경쟁사', weight: 3 },
      { term: '공모가 하회', weight: 4 },
    ],
  },
  {
    label: INFORMATIONAL_LABEL,
